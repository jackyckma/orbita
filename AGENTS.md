...
- Authoritative design spec: `usr/ORBITA_DESIGN.md`; W0–W33 in progress (w32 notes graph; w33 neighbors + vector search + `note_search`); wave roadmap `docs/development-plan.md`; editorial poll `docs/at-editorial-poll.md`; Loop 2/4 deferred (H2/H3); four-lane map in `docs/DEVELOPMENT_LANES.md`.
